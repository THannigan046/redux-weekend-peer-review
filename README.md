...
- Client code:
  ...
  - [x] Reducers & Actions Working
    ...
    (not type, but a cool star thing)
    - [x] Reducers are returning a new state, or the old state (not mutating)
    - [] Reducers are using spread correctly (to keep old data, while adding new)
    (not relevant, didn't need spread operator for this project )
...
```
Hey James. You did a solid job with this assignment. You efficiently/creatively stored your data across components, went above and beyond with the stretch assignments and made a cool, working functional page. Only thing I'd note is that you need to refactor your review page so it links to the thank you page, but that's a very small criticism. Overall great work. 
